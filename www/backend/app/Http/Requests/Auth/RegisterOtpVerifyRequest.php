<?php
/**
 * Request : RegisterOtpVerifyRequest.
 *
 * This file used to handle Register verify otp validations
 *
...
class RegisterOtpVerifyRequest extends FormRequest
{
    use UserTrait;
    ...
    public function messages()
    {
        return[
            ...
            'otp.digits' => trans('register.otp_digit_not_match'),
            'otp.otp' => trans('register.otp_notfound'),
            'otp.otp_expiry' => trans('register.otp_expired'),
        ];
    }
