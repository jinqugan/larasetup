    ...
    public function run()
    {
        $countries = array(
            ...
            array('id' => 3,'code' => 'DZ' ,'name' => "Algeria",'phonecode' => 213,'status'=>'active'
                ,'created_at' => date("Y-m-d H:i:s"),'updated_at' => date("Y-m-d H:i:s")),
            array('id' => 4,'code' => 'AS' ,'name' => "American Samoa",'phonecode' => 1684,'status'=>'active'
                ,'created_at' => date("Y-m-d H:i:s"),'updated_at' => date("Y-m-d H:i:s")),
            ...
            array('id' => 49,'code' => 'CG','name' => "Congo",'phonecode' => 242,'status'=>'active'
                ,'created_at' => date("Y-m-d H:i:s"),'updated_at' => date("Y-m-d H:i:s")),
            array('id' => 50,'code' => 'CD','name' => "Congo The Democratic Republic Of The",'phonecode' => 242,'status'=>'active'
                ,'created_at' => date("Y-m-d H:i:s"),'updated_at' => date("Y-m-d H:i:s")),
            ...
            array('id' => 57,'code' => 'CZ','name' => "Czech Republic",'phonecode' => 420,'status'=>'active'
                ,'created_at' => date("Y-m-d H:i:s"),'updated_at' => date("Y-m-d H:i:s")),
            array('id' => 58,'code' => 'DK','name' => "Denmark",'phonecode' => 45,'status'=>'active'
                ,'created_at' => date("Y-m-d H:i:s"),'updated_at' => date("Y-m-d H:i:s")),
            array('id' => 59,'code' => 'DJ','name' => "Djibouti",'phonecode' => 253,'status'=>'active'
                ,'created_at' => date("Y-m-d H:i:s"),'updated_at' => date("Y-m-d H:i:s")),
            ...
            array('id' => 96,'code' => 'HM','name' => "Heard and McDonald Islands",'phonecode' => 0,'status'=>'active'
                ,'created_at' => date("Y-m-d H:i:s"),'updated_at' => date("Y-m-d H:i:s")),
            ...
            array('id' => 168,'code' => 'PS','name' => "Palestinian Territory Occupied",'phonecode' => 970,'status'=>'active'
                ,'created_at' => date("Y-m-d H:i:s"),'updated_at' => date("Y-m-d H:i:s")),
